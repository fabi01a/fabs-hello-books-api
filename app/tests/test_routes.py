...
def test_get_all_books_with_no_records(client,two_saved_books):
    # Act
...
# When we call `read_one_book` with a numeric ID that doesn't have a record, 
# we get the expected error message
